...
export default function PhotosPage() {
  return (
    <GlobalGroupProvider>
      <AppShell currentApp="photos" bgColor="bg-transparent">
        <div className="h-full bg-gradient-to-br from-fuchsia-400 via-purple-400 to-pink-400 p-4 md:p-8 flex items-center justify-center">
