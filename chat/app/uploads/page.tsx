...
export default function UploadsPage() {
  return (
    <GlobalGroupProvider>
      <AppShell currentApp="uploads" bgColor="bg-transparent">
        <div className="h-full bg-gradient-to-br from-blue-400 via-purple-400 to-pink-400 p-4 md:p-8 flex items-center justify-center">
