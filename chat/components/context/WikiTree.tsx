    ...
    <div className="select-none">
      <div 
        className={clsx(
          ...
          isSelected ? "bg-indigo-50 text-indigo-700 font-medium" : "hover:bg-accent text-foreground",
      ...
      >
        ...
        {hasChildren ? (
            <Folder className={clsx("w-3.5 h-3.5", isSelected ? "text-indigo-500" : "text-muted-foreground")} />
        ) : (
            <FileText className={clsx("w-3.5 h-3.5", isSelected ? "text-indigo-500" : "text-muted-foreground")} />
        )}
        ...
        <div className="p-3 border-b border-border space-y-2">
            <div className="relative">
                ...
                <input 
                    ...
                    className="w-full pl-7 pr-2 py-1.5 text-xs bg-background border border-border rounded-md focus:outline-none focus:ring-1 focus:ring-indigo-500"
                />
            </div>
            <button 
                onClick={() => setIsCreating(true)}
                className="w-full flex items-center justify-center gap-1.5 py-1.5 text-xs font-medium bg-background border border-border text-foreground rounded-md hover:bg-accent hover:border-indigo-200 hover:text-indigo-600 transition-colors shadow-sm"
            >
