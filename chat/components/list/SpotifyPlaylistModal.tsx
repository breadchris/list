...
import { SpotifyPlaylist } from '@/lib/list/SpotifyService';
import { useSpotifyAuth } from '@/hooks/list/useSpotifyAuth';
import { useSpotifyPlaylists, useImportSpotifyPlaylist } from '@/hooks/list/useSpotifyPlaylists';
import { useToast } from './ToastProvider';
import { unlinkSpotifyAccount } from '@/lib/list/SupabaseClient';
...
export const SpotifyPlaylistModal: React.FC<SpotifyPlaylistModalProps> = ({
  ...
  console.log('🎵 Spotify Modal State:', {
    ...
    shouldShowLinkButton: !isAuthenticated && !authLoading,
    shouldShowPlaylists: !playlistsLoading && isAuthenticated && playlists && playlists.length > 0
  });
