...
import { Content, contentRepository, Tag, TagFilter, SEOMetadata, SharingMetadata, YouTubeVideoMetadata } from '@/lib/list/ContentRepository';
...
import { useActiveJobs } from '@/hooks/list/useJobsQueries';
import { useBatchUserVotes, useBatchContentVotes, calculateVoteScoresFromBatch } from '@/hooks/list/useContentVotes';
import { UserAvatar } from './UserAvatar';
import { supabase } from '@/lib/list/SupabaseClient';
import { QueryInvalidation } from '@/hooks/list/queryKeys';
import { PieMenu } from './pie/PieMenu';
import { useContentPieMenu } from '@/hooks/list/useContentPieMenu';
import { motion, AnimatePresence } from 'framer-motion';
import { useContentFocus } from '@/hooks/list/useContentFocus';
