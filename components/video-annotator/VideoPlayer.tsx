            ...
            {duration > 0 && (
              <div className="mt-3">
                ...
                >
                  {/* Buffered */}
                  <div
                    className="absolute top-0 left-0 h-full bg-white/50 rounded-full transition-all pointer-events-none"
                    style={{ width: `${(bufferedTime / duration) * 100}%` }}
                  />
                  {/* Progress */}
                  <div
                    className="absolute top-0 left-0 h-full bg-red-600 rounded-full transition-all pointer-events-none"
                  ...
                  {annotations.map((annotation, index) => {
                    ...
                    return (
                      <div
                        ...
                        className="absolute top-0 h-full bg-yellow-400 rounded-full pointer-events-none opacity-70 group-hover:opacity-90"
                        style={{
                          left: `${startPos}%`,
                          width: `${width}%`
                        }}
