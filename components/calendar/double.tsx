  ...
  return (
    <div>
      <div className="relative grid grid-cols-1 gap-x-14 md:grid-cols-2">
        <button
          type="button"
          className="absolute -top-1 -left-1.5 flex items-center justify-center p-1.5 text-gray-400 hover:text-white"
        >
        ...
        <button
          type="button"
          className="absolute -top-1 -right-1.5 flex items-center justify-center p-1.5 text-gray-400 hover:text-white"
        >
      ...
      <section className="mt-12">
        ...
        <ol className="mt-2 divide-y divide-white/10 text-sm/6 text-gray-400">
          ...
          <li className="py-4 sm:flex">
            ...
            <p className="mt-2 flex-auto font-semibold text-white sm:mt-0">
