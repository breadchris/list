          ...
          <div className="flex w-full flex-auto">
            ...
            <div className="grid flex-auto grid-cols-1 grid-rows-1">
              ...
              >
                ...
                <div>
                  <div className="-mt-2.5 -ml-14 w-14 pr-2 text-right text-xs/5 text-gray-500">
                    12AM
                  </div>
                </div>
                <div />
              ...
              >
                ...
                >
                  ...
                  >
                    <p className="order-1 font-semibold text-blue-300">
                      Breakfast
                    </p>
                ...
                >
                  ...
                  >
                    <p className="order-1 font-semibold text-pink-300">
                      Flight to Paris
                    </p>
                ...
                >
                  ...
                  >
                    <p className="order-1 font-semibold text-indigo-300">
                      Sightseeing
                    </p>
                    <p className="order-1 text-indigo-400 group-hover:text-indigo-300">
                      Eiffel Tower
                    </p>
