...
export const ContentTypeSelector: React.FC<ContentTypeSelectorProps> = ({
  ...
  return (
    <div className="px-4 py-3">
      <div className="flex items-center gap-3 px-4 py-3 overflow-x-auto [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
        <button
