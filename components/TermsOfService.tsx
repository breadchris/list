      ...
      <div className="container mx-auto max-w-4xl px-4 py-12">
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              Please review our <Link to="/privacy-policy" className="link link-primary">Privacy Policy</Link>,
          ...
          <section className="mb-8">
            ...
            <p>
              ...
              Payment terms and refund policies are detailed in our <Link to="/refund-policy" className="link link-primary">Refund Policy</Link>.
            </p>
            <p className="mt-3">
        ...
        <div className="mt-12 pt-8 border-t border-gray-300">
          <p className="text-center text-gray-600">
            ...
            <Link to="/privacy-policy" className="link link-primary mr-4">Privacy Policy</Link>
